...
4. **Artikelstamm ist filialübergreifend** und bleibt — einzige Ausnahme: ein von Hand erfasster Artikel ohne Beleg darf von Filialleitern ganz gelöscht werden (Fehleintrag, Entscheid 24.09.2026). Sonst gilt:, Bestand / Wareneingänge / Reduktionen sind filialbezogen (`lagerort_id`).
